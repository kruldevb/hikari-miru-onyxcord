"""Miru integration for User Select component in modals."""
...
__all__ = ["OnyxUserSelect"]


class OnyxUserSelect:
    """Miru ModalItem implementation for User Select component.
    ...
    def to_payload(self) -> dict[str, t.Any]:
        payload: dict[str, t.Any] = {"type": 5, "custom_id": self._custom_id}
        if self.placeholder:
